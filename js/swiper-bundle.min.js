		...
		return (
			r.WebKitCSSMatrix
				...
				: (i = (a =
						...
						.split(',')),
			'x' === t &&
				(s = r.WebKitCSSMatrix ? a.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
			'y' === t &&
				(s = r.WebKitCSSMatrix ? a.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
			s || 0
		);
	}
	function C(e) {
	...
	var W = {
			update: function (e) {
				...
				if (
					...
					return (
						t.slidesGrid !== c && x !== f && t.slides.css(m, x + 'px'), void t.updateProgress()
					);
						...
						if (t.params.loop) {
							...
							var o = t.slides
								...
								d = t.slides
									...
									.index();
							(r =
								void 0 === o ? d : void 0 === d ? o : d - l == l - o ? l : d - l < l - o ? d : o),
